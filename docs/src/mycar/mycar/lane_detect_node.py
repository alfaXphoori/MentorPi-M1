...
class LaneDetectNode(Node):
    def __init__(self):
        ...
        self.lower_yellow = np.array(self.get_parameter('lower_yellow').get_parameter_value().integer_array_value)
        self.upper_yellow = np.array(self.get_parameter('upper_yellow').get_parameter_value().integer_array_value)
        self.lower_white = np.array(self.get_parameter('lower_white').get_parameter_value().integer_array_value)
        self.upper_white = np.array(self.get_parameter('upper_white').get_parameter_value().integer_array_value)
        self.use_white = self.get_parameter('use_white').get_parameter_value().bool_value
